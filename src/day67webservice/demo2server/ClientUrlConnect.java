...
public class ClientUrlConnect {
	public static void main(String[] args) throws Exception {
		//创建url对象
		URL url=new URL("http://127.0.0.1:8092/hello?wsdl");
		//根据url对象得到连接对象
		...
		String data="<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" "
				+ "xmlns:q0=\"http://demo2server.day67webservice/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" "
